...
const STRINGS = {
  ...
  /* Tekil hal — kart uzerinde "1 okunmadi" olarak gorunur. */
  ...
  /* ana ekrana ekle */
  'install.title':      { en: 'Add to home screen',
                          es: 'Añádela a tu pantalla de inicio',
                          tr: 'Ana ekrana ekle' },
  'install.sub':        { en: 'Opens full screen, works offline.',
                          es: 'Se abre a pantalla completa y funciona sin conexión.',
                          tr: 'Tam ekran açılır, çevrimdışı da çalışır.' },
  'install.add':        { en: 'Add',   es: 'Añadir', tr: 'Ekle' },
  'install.how':        { en: 'How?',  es: '¿Cómo?', tr: 'Nasıl?' },
  'install.dismiss':    { en: 'Not now', es: 'Ahora no', tr: 'Şimdi değil' },
  'install.howTitle':   { en: 'Add Daily Now to your home screen',
                          es: 'Añade Daily Now a tu pantalla de inicio',
                          tr: 'Daily Now’ı ana ekranına ekle' },
  'install.howSub':     { en: 'Three taps in Safari — no app store needed.',
                          es: 'Tres toques en Safari, sin pasar por la App Store.',
                          tr: 'Safari’de üç dokunuş — App Store’a gerek yok.' },
  'install.step1':      { en: 'Tap the Share button in Safari’s bottom bar.',
                          es: 'Toca el botón Compartir en la barra inferior de Safari.',
                          tr: 'Safari’nin alt çubuğundaki Paylaş düğmesine dokun.' },
  'install.step2':      { en: 'Scroll down the menu and choose “Add to Home Screen”.',
                          es: 'Baja por el menú y elige “Añadir a pantalla de inicio”.',
                          tr: 'Menüyü aşağı kaydırıp “Ana Ekrana Ekle”yi seç.' },
  'install.step3':      { en: 'Tap “Add” at the top right — the icon lands on your home screen.',
                          es: 'Toca “Añadir” arriba a la derecha; el icono aparecerá en tu pantalla de inicio.',
                          tr: 'Sağ üstteki “Ekle”ye dokun; simge ana ekranına düşer.' },
  'site.note':          { en: 'Daily Now scans the news sites each morning and writes short AI-assisted summaries, so you can catch up on the day in one place. Every story links out to its original source.',
                          es: 'Daily Now revisa cada mañana los medios y redacta resúmenes breves con ayuda de IA, para que te pongas al día en un solo lugar. Cada noticia enlaza con su fuente original.',
                          tr: 'Daily Now her sabah haber sitelerini tarayıp yapay zeka desteğiyle kısa özetler çıkarır; günü tek yerden yakalayabilesin diye. Her haber kendi kaynağına bağlantı verir.' },
  'install.gotIt':      { en: 'Got it', es: 'Entendido', tr: 'Anladım' },
